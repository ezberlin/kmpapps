...
@NonNullApi
public class VPlanXProjectDependency extends DelegatingProjectDependency {

    @Inject
    public VPlanXProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
